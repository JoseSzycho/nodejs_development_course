...
- [Class 7 - Arrays](#class-7---arrays)
    - [What are arrays](#what-are-arrays)
        - [Array pros](#array-pros)
        - [Arrays cons](#arrays-cons)
    - [Degining an array](#degining-an-array)
        - [Array literal](#array-literal)
        - [Array.of](#arrayof)
        - [Array.fill](#arrayfill)
        - [Array constructor _NOT RECOMENDED_](#array-constructor-_not-recomended_)
    - [A property and some methods](#a-property-and-some-methods)
        ...
        - [Merge arrays with spread operator](#merge-arrays-with-spread-operator)
        ...
        - [rray.prototype.join](#rrayprototypejoin)
        - [Array.from](#arrayfrom)
        - [Copy array unique elements using Set](#copy-array-unique-elements-using-set)
        - [Best way for clearing an array](#best-way-for-clearing-an-array)
        - [Array.prototype.forEach](#arrayprototypeforeach)
    - [Ways to iterate over an array](#ways-to-iterate-over-an-array)
        - [Array.prototype.forEach](#arrayprototypeforeach)
        - [for...of](#forof)
        - [for...in](#forin)
        - [for](#for)
        ...
        - [Good practices for array iterators](#good-practices-for-array-iterators)
    - [Homework](#homework)
    - [Task 1: Advanced Array Filtering](#task-1-advanced-array-filtering)
    - [Task 2: Array Chunking](#task-2-array-chunking)
    - [Task 3: Array Shuffling](#task-3-array-shuffling)
    - [Task 4: Array Intersection and Union](#task-4-array-intersection-and-union)
    - [Task 5: Array Performance Analysis](#task-5-array-performance-analysis)
